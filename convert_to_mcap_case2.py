...
def main():
    ...
    parser.add_argument(
        "--result_json_name1",
        "-p",
        default= "tracking_result_base.json",
        help="path to infer result",
    )
    parser.add_argument(
        "--result_json_name2",
        default= "tracking_result_update.json",
        help="path to infer result",
    )
    ...
    for name in args.dataset_name:
        ...
        if args.list_only:
            nusc.list_scenes()
            return
        pred_json_file = os.path.join(root_injson, args.result_json_name1)
        pred_json_file2 = os.path.join(root_injson, args.result_json_name2)
