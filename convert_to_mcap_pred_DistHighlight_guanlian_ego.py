    ...
    with open(filepath, "wb") as fp:
        ...
        while cur_sample is not None:
            ...
            for ann in anns:
                ...
                guanpre_anns[ann["tracking_id"]] = [ann_center[0], ann_center[1], ann_center[2], ann_orientation[1]]
            ...
            for annotation_id in cur_sample["anns"]:
                ...
                guangt_anns[ann["instance_token"]] = [ann_center[0],ann_center[1],ann_center[2],ann_orientation[1]]
                cube.pose.position.x = ann_center[0]
                cube.pose.position.y = ann_center[1]
                cube.pose.position.z = ann_center[2]
                cube.pose.orientation.w = ann_orientation[0]
